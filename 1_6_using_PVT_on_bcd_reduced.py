...
#        self.bigCloneBench_Corpus_max_sentence_length
        ...
        path_pkl_root='./vector/diffweight/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunction_ID_Map_Vector_root.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
#        path_pkl_root='./vector/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunction_ID_Map_Vector_root.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
        ...
        path_pkl_mean='./vector/diffweight/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunction_ID_Map_Vector_mean.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
#        path_pkl_mean='./vector/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunction_ID_Map_Vector_weighted.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
        ...
        path_pkl_weighted_TF_IDF='./vector/diffweight/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunction_ID_Map_Vector_weighted.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
#        path_pkl_mean='./vector/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunction_ID_Map_Vector_weighted.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
        if os.path.exists(path_pkl_mean):  # 如果文件存在
        # 删除文件，可使用以下两种方法。
            os.remove(path_pkl_mean)  
        ...
        path_pkl_meanAndRootMost='./vector/diffweight/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunctionID_Map_Vector_meanAndRootMost.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
#        path_pkl_meanAndRootMost='./vector/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunctionID_Map_Vector_meanAndRootMost.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
        if os.path.exists(path_pkl_root):  # 如果文件存在
        # 删除文件，可使用以下两种方法。
            os.remove(path_pkl_root)  
        else:
        ...
        path_pkl_weightedAndCengci='./vector/diffweight/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunctionID_Map_Vector_weightedAndCengci.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
#        path_pkl_weightedAndCengci='./vector/'+random_str+'_using_Weigthed_RAE_BigCloneBenchFunctionID_Map_Vector_weightedAndCengci.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
        if os.path.exists(path_pkl_root):  # 如果文件存在
        # 删除文件，可使用以下两种方法。
            os.remove(path_pkl_root)  
        else:
...
#            print('no such file:%s'%path_pkl_mean) # 则返回文件不存在
        ...
        path_pkl_root='./vector/'+str(xiaojiepkl_index)+'_fullCorpusLine_PVT_root.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
        if os.path.exists(path_pkl_root):  # 如果文件存在
        # 删除文件，可使用以下两种方法。
            os.remove(path_pkl_root)  
        else:
            print('no such file:%s'%path_pkl_root) # 则返回文件不存在
        path_pkl_mean='./vector/'+str(xiaojiepkl_index)+'_fullCorpusLine_PVT_mean.xiaojiepkl'#为了便于找到这个随机文件，我们用xiaojienpy作为格式后缀
        if os.path.exists(path_pkl_mean):  # 如果文件存在
        # 删除文件，可使用以下两种方法。
            os.remove(path_pkl_mean)  
        else:
